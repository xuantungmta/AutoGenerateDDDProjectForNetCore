        ...
        public static void MakeProject(string sourcePath)
        {
            ...
            foreach (FileInfo file in files)
            {
                ...
                File.WriteAllText(temppath, File.ReadAllText(temppath).
                    Replace(Convention.PROJECT_NAME, XMLSettings.ProjectName).
                    Replace(Convention.DATBASE_NAME, XMLSettings.DatabaseName).
                    Replace(Convention.DATBASE_USERNAME, XMLSettings.SQLUsername).
                    Replace(Convention.DATBASE_PASSWORD, XMLSettings.SQLPassword));
            }
