...
namespace AutoGenerateDDDProjectForNetCore.controls
{
    ...
    public class TextProgressBar : ProgressBar
    {
        ...
        public Font TextFont { get; set; } = new Font("Arial", (float)8.25, FontStyle.Regular);
    ...
    public static class ProcessBarExtensions
    {
        public static void StartProcess(this ProgressBar progressBar) { progressBar.Value = 0; }
        public static void EndProcess(this ProgressBar progressBar) { progressBar.Value = 100; }
        public static Task IncrementProcess(this ProgressBar progressBar, int step = 10)
        {
